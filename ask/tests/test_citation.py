...
class TestChunkText:
    ...
    def test_no_overlap_needed_for_short_text(self):
        """Test that short text doesn't need overlap."""
...
class TestIntegration:
    ...
    def test_chunk_with_valid_overlap(self):
        """Test that chunk boundaries work with valid overlap."""
        text = "word " * 100
        chunks = chunk_text(text, max_tokens=40, overlap=10)
        
        # 100 words / (40-10) step = ~4 chunks
        assert len(chunks) >= 2
